...
def clean_text(text):
    ...
    text=re.sub(pattern=mention_pattern, repl='', string=text)
...
if __name__ == '__main__':
    txt = "@Jeremy_Hunt trying to sneak Junior doctors contracts through while media focussed on Chilcott?? You utter cunt. #Fuckyouandyourtoryparty"
    re = clean_text(txt)
    print(re)
